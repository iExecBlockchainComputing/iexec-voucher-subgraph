...
export function handleDefaultAdminTransferCanceled(event: DefaultAdminTransferCanceledEvent): void {
...
export function handleEligibleAssetAdded(event: EligibleAssetAddedEvent): void {
    let entity = new EligibleAssetAdded(event.transaction.hash.concatI32(event.logIndex.toI32()));
...
export function handleEligibleAssetRemoved(event: EligibleAssetRemovedEvent): void {
    let entity = new EligibleAssetRemoved(event.transaction.hash.concatI32(event.logIndex.toI32()));
    entity.VoucherHub_id = event.params.id;
    entity.asset = event.params.asset;
...
export function handleVoucherCreated(event: VoucherCreatedEvent): void {
    let entity = new VoucherCreated(event.transaction.hash.concatI32(event.logIndex.toI32()));
...
export function handleVoucherDebited(event: VoucherDebitedEvent): void {
    let entity = new VoucherDebited(event.transaction.hash.concatI32(event.logIndex.toI32()));
    entity.voucher = event.params.voucher;
    entity.sponsoredValue = event.params.sponsoredValue;
...
export function handleVoucherTypeCreated(event: VoucherTypeCreatedEvent): void {
    let entity = new VoucherTypeCreated(event.transaction.hash.concatI32(event.logIndex.toI32()));
    entity.VoucherHub_id = event.params.id;
...
export function handleVoucherTypeDurationUpdated(event: VoucherTypeDurationUpdatedEvent): void {
